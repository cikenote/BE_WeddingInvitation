...
public interface IEventService
{
    ...
    Task<ResponseDTO> UploadEventBackgroundImg(Guid EventId, UploadEventBackgroundImg uploadEventBackgroundImg);
    Task<MemoryStream> DisplayEventBackgroundImg( Guid EventId);
}